// Removed duplicate/conflicting Event and EventStatus definitions.
// Use the unified Event type/interface further below in the file.
...
export interface Event {
  ...
  dateStart?: ISODateString | number;
  dateEnd?: ISODateString | number;
  timezone?: string;
  venue?: Venue;
  locationText?: string;
  summary?: string;
  ...
  // Additional fields for event details component
  date?: string;
  time?: string;
  place?: string;

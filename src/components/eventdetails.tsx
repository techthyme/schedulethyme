        ...
        <div className="w-1/2 bg-gradient-to-br from-indigo-50 via-white to-violet-50 p-6">
          ...
          <div className="relative aspect-[4/3] bg-gradient-to-br from-indigo-100 to-violet-100 rounded-2xl overflow-hidden shadow-lg mb-4">
            ...
            <div className="absolute top-3 left-3">
              <span className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium shadow-lg backdrop-blur-sm ${
            ...
            <div className="relative aspect-[16/9] bg-gray-900 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 font-medium text-sm">Event Image</p>
                </div>
              </div>
            </div>
        ...
        <div className="w-1/2 p-6">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center text-gray-600">
              ...
              <span className="font-light text-sm">{event.time || "Time TBD"}</span>
            </div>
          </div>
          ...
          {event.description && (
            <div className="mb-4">
              ...
              <p className="text-gray-600 font-light leading-relaxed text-sm">{event.description}</p>
            </div>
          )}
          ...
          {event.instructors && event.instructors.length > 0 && (
            <div className="mb-4">
              <h3 className="text-sm font-medium text-gray-900 mb-2">Event Instructors</h3>
                ...
                {event.instructors.map((instructor, index) => (
                  <div key={index} className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {instructor.title && (
                        <div className="text-xs text-gray-600 truncate">{instructor.title}</div>
                      )}
                    </div>
                  </div>
                ))}

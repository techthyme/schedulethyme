...
export default function ProfileClient({ profile }: ProfileClientProps) {
  const { user, bio, name, avatarUrl, profession, organization, events } =
    profile;
              ...
              <div className="bg-white/95 dark:bg-neutral-900/95 backdrop-blur-sm rounded-2xl border border-neutral-200/50 dark:border-neutral-700/50 p-8 shadow-sm">
                ...
                {events && events.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400">
                      You have a free schedule today. Time to plan something
                      exciting!
                    </p>
                  </div>
                )}
              ...
              <div className="bg-white/95 dark:bg-neutral-900/95 backdrop-blur-sm rounded-2xl border border-neutral-200/50 dark:border-neutral-700/50 p-8 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-neutral-900 dark:text-white">
                        Registered for &quot;Digital Marketing Training&quot;
                      </p>
                      <p className="text-sm text-neutral-600 dark:text-neutral-400">
                        1 day ago
                      </p>

          ...
          <div className="relative lg:col-span-3">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)] lg:rounded-tl-[calc(2rem+1px)]">
              ...
              <div className="p-6 text-center">
                ...
                {/* Profile Header */}
                <div className="mb-4">
                  <p className="text-sm text-gray-500 font-light">@{user.name.toLowerCase().replace(' ', '')}</p>
                  <h3 className="text-xl font-light text-gray-900 mt-1">{user.name}</h3>
                ...
                <div className="text-left">
                  <h4 className="text-lg font-light text-gray-900 mb-3">Information</h4>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-light text-gray-900">www.TechThyme.com</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3 text-gray-600">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-sm font-light text-gray-900">Hello@techthyme.com</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3 text-gray-600">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-sm font-light text-gray-900">+1 340 244 7893</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3 text-gray-600">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-sm font-light text-gray-900">26 March, 2023</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  <div className="flex flex-wrap gap-2 justify-center">
                    <span className="px-3 py-1.5 text-sm font-light bg-gray-100 text-gray-700 rounded-full">AI Designer</span>
                    <span className="px-3 py-1.5 text-sm font-light bg-gray-100 text-gray-700 rounded-full">UX Designer</span>
                    <span className="px-3 py-1.5 text-sm font-light bg-gray-100 text-gray-700 rounded-full">Design System</span>
                    <span className="px-3 py-1.5 text-sm font-light bg-gray-100 text-gray-700 rounded-full">Product</span>
                    <span className="px-3 py-1.5 text-sm font-light bg-gray-100 text-gray-700 rounded-full">Successful</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="h-40 bg-gradient-to-r from-emerald-500 to-teal-600 relative">
                ...
                <div className="relative p-8 h-full flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-3xl font-light text-white mb-2">{todaysEvents.length}</div>
                    <div className="text-emerald-100">Events Today</div>
                  </div>
                </div>
              </div>
              <div className="p-10 pt-6">
                <h3 className="text-sm/4 font-light text-emerald-600">Schedule</h3>
                <p className="mt-2 text-lg font-light tracking-tight text-gray-950">Today's Events</p>
                        ...
                        <div className="flex items-start space-x-3 flex-1">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-1">
                              <p className="text-sm font-light text-gray-950">{event.title}</p>
                              <span className="px-2 py-0.5 text-xs font-light bg-emerald-100 text-emerald-700 rounded-full">
                                {event.type || 'Workshop'}
                              </span>
                            </div>
                            <p className="text-xs text-gray-500">{event.time}</p>
                            <p className="text-xs text-gray-400 mt-1">{event.location || 'Conference Room A'}</p>
                          </div>
                        </div>
                ...
                <div className="mt-6">
                  <p className="text-xs font-light text-gray-600 mb-2">This Week</p>
                ...
                <div className="mt-6 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      <p className="text-xs font-light text-yellow-800">Reminder: Bring presentation slides for AI Workshop</p>
                    </div>
                  </div>
                </div>
              </div>

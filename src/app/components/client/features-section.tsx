...
const features: Feature[] = [
  {
    ...
    description: 'Check space availability and book instantly with our real-time booking system.',
    icon: 'clock'
  },
  {
    id: 'mobile-first',
  ...
  },
  {
    ...
    description: 'Sync with Google Calendar and Outlook to manage all your appointments.',
    icon: 'calendar'
  },
  {
    id: 'expert-network',
    title: 'Expert Network',
    description: 'Access a curated network of professional trainers and consultants.',
    icon: 'star'
  },
  {
    id: 'flexible-scheduling',
    title: 'Flexible Scheduling',
    description: 'Book by the hour, day, or recurring sessions to fit your needs.',
    icon: 'adjustments'
  },
  {
    id: 'secure-payments',
    ...
    <Section className="bg-white">
      ...
      <div className="bg-blue-50 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          Join thousands of professionals who trust ScheduleThyme for their space, training, and consulting needs.
        </p>

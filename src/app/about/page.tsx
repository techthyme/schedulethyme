      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="mt-20 grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-full h-48 bg-gradient-to-br from-orange-200 to-pink-200 rounded-2xl mb-6 flex items-center justify-center">
                <div className="text-6xl">🏢</div>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Professional Spaces</h3>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-full h-48 bg-gradient-to-br from-yellow-200 to-orange-200 rounded-2xl mb-6 flex items-center justify-center">
                <div className="text-6xl">🎓</div>
              </div>
            ...
            <div className="lg:row-span-2 bg-gradient-to-br from-blue-200 to-teal-200 rounded-3xl p-8 relative overflow-hidden">
              <div className="relative z-10 h-full flex flex-col">
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-8xl mb-8">🏝️</div>
                </div>
                <div className="bg-black/70 text-white rounded-2xl p-4 flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {aboutUsData.values.map((value, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-pink-500 rounded-xl mb-6 flex items-center justify-center">

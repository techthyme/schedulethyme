          ...
          <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              <h1 className="max-w-2xl text-5xl font-extralight tracking-tight text-balance text-gray-900 sm:text-7xl lg:col-span-2 xl:col-auto">
                Connecting Caribbean professionals through seamless space
                scheduling
              </h1>
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-lg font-light text-pretty text-gray-500 sm:text-xl/8">
                  ScheduleThyme brings together businesses, professionals, and
                  organizations across the US Virgin Islands through our
                  comprehensive facility scheduling platform. From conference
                  centers in Charlotte Amalie to training spaces in
                  Christiansted, we make it easy to find, book, and manage the
                  perfect space for your next meeting, workshop, or consulting
                  session.
                </p>
              </div>
              <img
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:max-w-none lg:min-w-full lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                <p className="mt-6 text-xl/8 text-gray-700">
                  We&apos;re proud to serve the vibrant business community of
                  the US Virgin Islands. Our team understands the unique
                  challenges and opportunities of doing business in the
                  Caribbean, and we&apos;re committed to supporting local growth
                  and development.
                </p>
                <p className="mt-6 text-base/7 text-gray-600">
                  From small startups in Cruz Bay to established enterprises in
                  Frederiksted, we provide the tools and spaces needed to foster
                  collaboration, learning, and business success across all three
                  major islands.
                </p>
              </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-light tracking-tight text-pretty text-gray-900 sm:text-5xl">
              Empowering Caribbean businesses through accessible facilities and
              training
            </h2>
            <p className="mt-6 text-base/7 text-gray-600">
              Our mission is to strengthen the business ecosystem of the US
              Virgin Islands by providing easy access to professional
              facilities, world-class training programs, and expert consulting
              services. We believe that great spaces and quality education are
              the foundation of economic growth.
            </p>
          </div>
          <div className="mx-auto mt-16 flex max-w-2xl flex-col gap-8 lg:mx-0 lg:mt-20 lg:max-w-none lg:flex-row lg:items-end">
            <div className="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl bg-gray-50 p-8 sm:w-3/4 sm:max-w-md sm:flex-row-reverse sm:items-end lg:w-72 lg:max-w-none lg:flex-none lg:flex-col lg:items-start">
              <p className="flex-none text-3xl font-light tracking-tight text-gray-900">
                150+
              </p>
              <div className="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                ...
                <p className="mt-2 text-base/7 text-gray-600">
                  Conference rooms, training centers, and meeting spaces across
                  the USVI.
                </p>
              </div>
            </div>
            <div className="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl bg-gray-900 p-8 sm:flex-row-reverse sm:items-end lg:w-full lg:max-w-sm lg:flex-auto lg:flex-col lg:items-start lg:gap-y-44">
              <p className="flex-none text-3xl font-light tracking-tight text-white">
                2,500+
              </p>
              <div className="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                <p className="text-lg font-light tracking-tight text-white">
                  Professionals trained through our certification and workshop
                  programs.
                </p>
                <p className="mt-2 text-base/7 text-gray-400">
                  Building skills and expertise across the Caribbean business
                  community.
                </p>
              </div>
            </div>
            <div className="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl bg-indigo-600 p-8 sm:w-11/12 sm:max-w-xl sm:flex-row-reverse sm:items-end lg:w-full lg:max-w-none lg:flex-auto lg:flex-col lg:items-start lg:gap-y-28">
              ...
              <div className="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                ...
                <p className="mt-2 text-base/7 text-indigo-200">
                  Our clients consistently rate their experience with our
                  facilities and services as exceptional.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
            <div className="w-full lg:max-w-lg lg:flex-auto">
              ...
              <p className="mt-6 text-xl/8 text-gray-600">
                We&apos;re looking for passionate individuals who understand the
                unique opportunities and challenges of doing business in the US
                Virgin Islands. Help us build the infrastructure that supports
                local economic growth and professional development.
              </p>
              <img
                alt=""
            ...
            <div className="w-full lg:max-w-xl lg:flex-auto">
                ...
                {jobOpenings.map((opening) => (
                  <li key={opening.id} className="py-8">
                    <dl className="relative flex flex-wrap gap-x-3">
                      ...
                      <dd className="mt-4 text-base/7 font-light text-gray-900">
                        {opening.salary}
                      </dd>
              ...
              <div className="mt-8 flex border-t border-gray-100 pt-8">
                <a
                  href="#"
                  className="text-sm/6 font-light text-indigo-600 hover:text-indigo-500"
                >
